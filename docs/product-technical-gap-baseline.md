...
| Calendar Resource Core candidates remain below consumer parity | CalendarWeave #2 / ADR-0002 / ADR-0003 | Stacked candidates cover strict VEVENT create/conditional-update/list/get, RFC status, authorization-before-parse, and PostgreSQL restart/concurrency evidence with 100% line/branch coverage; add external authorization admission, operated backup/recovery evidence, TZID/DURATION, and declared privacy/content semantics before release or consumer migration |
